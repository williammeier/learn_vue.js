    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        <div class="py-4 text-left px-6">
          ...
          <!-- Registration Form -->
          <app-register-form-vue v-if="tab === 'register'" />
...
import AppLoginFormVue from './LoginForm.vue';
import AppRegisterFormVue from './RegisterForm.vue';

export default {
  name: 'ModalAuth',
  components: {
    AppLoginFormVue, AppRegisterFormVue,
  },
  data() {
    return {
      tab: 'login',
